resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  origin {
    domain_name = aws_s3_bucket.single-view-fe-prototype.bucket_regional_domain_name
    origin_id   = aws_s3_bucket.single-view-fe-prototype.bucket
    s3_origin_config {
  ...
  default_cache_behavior {
    ...
    target_origin_id = aws_s3_bucket.single-view-fe-prototype.bucket
