    ...
    const search = () => {
        ...
        for (let key in data) {
            ...
            for (let searchKey in searchData) {
                if (searchData[searchKey] && item[searchKey].indexOf(searchData[searchKey]) > -1) {
                    score++;
                }
            }
    ...
    return (
        <>
            <p className="lbh-body-s">
                <a href="/search?context=phone">Search by phone number</a>
            </p>
                            ...
                            <fieldset className="govuk-fieldset" role="group" aria-describedby="dob-hint">
                                ...
                                <div className="govuk-date-input lbh-date-input" id="dob">
                                    <div className="govuk-date-input__item">
                                        ...
                                        <label className="govuk-label lbh-label" htmlFor="dob-day">
                                            Day
                                        </label>
                                        <input
                                    ...
                                    <div className="govuk-date-input__item">
                                        <div className="govuk-form-group">
                                        <label className="govuk-label lbh-label" htmlFor="dob-month">
                                            Month
                                        </label>
                                        <input
                                            className="govuk-input govuk-date-input__input govuk-input--width-2"
                                    ...
                                    <div className="govuk-date-input__item">
                                        <div className="govuk-form-group">
                                        <label className="govuk-label lbh-label" htmlFor="dob-year">
                                            Year
                                        </label>
                                        <input
